...
//  Widget weightOptions(BuildContext context, int value) {
//    return new Container(
//        decoration: new BoxDecoration(
//            border: Border.all(
//                width: 1.6,
//                color: value == selected_qty ? Colors.blue : Colors.grey),
...
//              child: new Text(
//                "MRP: Rs ${item_options[value]['price']}",
//                style: new TextStyle(fontSize: 16, fontWeight: FontWeight.w700),
//                textDirection: TextDirection.ltr,
//              )),
//          secondary: new Text(
//            "${item_options[value]['weight']}",
//            style: new TextStyle(fontSize: 16, fontWeight: FontWeight.w700),
//            textDirection: TextDirection.ltr,
//          ),
//          groupValue: selected_qty,
                  ...
                  children: <Widget>[
                    ...
                    new FlatButton(
                        ...
                        child: new Container(
                          ...
                          decoration: new BoxDecoration(
                              border:
                                  Border.all(width: 1.6, color: Colors.blue),
                              borderRadius:
                                  BorderRadius.all(Radius.circular(5))),
                        )),
                    new Padding(
